...
def get_data():
  try:
    ...
    with sqlite3.connect(DB_PATH) as conn:
      data = pd.read_sql_query('select * from NJ_PWS', conn)
    # Map all SDWA PWS
...
st.html('<img src="https://github.com/edgi-govdata-archiving/EEW-Image-Assets/blob/main/Jupyter%20instructions/eew.jpg?raw=true" alt="EEW Logo" width="250"/> <img src="https://github.com/edgi-govdata-archiving/EEW-Image-Assets/blob/main/Jupyter%20instructions/edgi.png?raw=true" alt="EDGI Logo" width="250"/>')
...
with st.spinner(text="Loading data..."):
  ...
  if "these_data" not in st.session_state: # local SDWA numbers for charts
    st.session_state["these_data"] = local_sdwa_circles
